...
- The active pen name is controlled by the `ELEVENTY_PEN_NAME` environment variable (defaults to first profile)
- The `build-all-sites.js` script sets `ELEVENTY_PEN_NAME` for each build iteration
