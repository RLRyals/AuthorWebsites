...
1. **Build your websites**
   ...
   - This creates folders like `_site_rodthunderen`, `_site_janedoe`, etc.
...
3. **Drag and Drop**
   - Find your built folder (e.g., `_site_rodthunderen`)
...
4. **Get Your URL**
   ...
   - Example: `rodthunderen.netlify.app`

5. **Add Custom Domain (Optional)**
   - In site settings, click "Domain management"
   - Click "Add custom domain"
   - Enter your domain (e.g., `rodthunderen.com`)
...
3. **Create Config File**
   ...
   {
     "Rod Thunderen": {
       "siteName": "rodthunderen",
       "siteId": "",
       "customDomain": "rodthunderen.com"
     }
   }
   ```
...
2. You'll get a URL like: `rodthunderen.netlify.app`
...
3. **Deploy via Web Interface**
   ...
   - Drag your `_site_rodthunderen` folder
...
1. Open terminal
2. Run: `npm run deploy:netlify "Rod Thunderen"`
...
3. Save
4. Run: `npm run deploy:netlify "Rod Thunderen"`
...
1. **Different domains:**
   - Rod Thunderen → `rodthunderen.com`
...
Check the `ELEVENTY_PEN_NAME` environment variable, or look at the first profile in `src/_data/profiles.js` (used as default)
...
Examples:
- ✅ `rodthunderen.com` for Vin
- ✅ `janedoe.com` for Jane
- ❌ `rodthunderen.com/janedoe` - Don't do this!
...
- `rodthunderen-author.netlify.app`
...
|----------|-------------|---------------|-------|
| Rod Thunderen | rodthunderen.netlify.app | rodthunderen.com | Urban Fantasy |
